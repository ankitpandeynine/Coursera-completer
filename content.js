...
(function() {
    ...
    async function handleDialogueItem() {
        if (window.CourseraDialogueRunner && typeof window.CourseraDialogueRunner.handleDialogue === 'function') {
            return await window.CourseraDialogueRunner.handleDialogue({
                showStatus,
                addLog,
                triggerClick,
                findNextItemButton,
